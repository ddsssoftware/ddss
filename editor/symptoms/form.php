...
<div class="field">
    ...
    <div class="control">
        <input class="input" type="text" id="id" name="id" value="<?= isset($symptom) ? $symptom['id'] : '' ?>" disabled>
    </div>
</div>
<div class="field">
    <label class="label" for="name">Name</label>
    <div class="control">
        <input class="input" type="text" id="name" name="name" value="<?= isset($symptom) ? $symptom['name'] : '' ?>" required>
    </div>
</div>
<div class="field pb-6">
    ...
    <div class="control radios is-block">
        <?php
        foreach (array_slice($diagnoses, -5, 5) as $d) {
