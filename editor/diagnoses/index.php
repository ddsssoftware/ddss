...
$diagnosesJs = PHP_EOL . 'new gridjs.Grid({columns: ["ID", "ICD", "Name", {name:"Actions",formatter: (_, row) => gridjs.html("<a href=\"/diagnoses/show.php?id="+row.cells[0].data+"\">Edit</a>")}],search:true,pagination:true,' . PHP_EOL;
